...
4. Frontend triggers: Solana transfer (SOLONA → Escrow)
...
3. Option A: Deposit to wallet → Transfer SOLONA to recipient
...
- **Why**: Low fees (<$0.001), fast (~400ms), SOLONA support
...
| ------------------- | ----------- | ------------------------- |
| `createTransaction` | 0           | Transfer SOLONA to escrow |
...
2. **Token check**: Token program must match SOLONA mint
...
_System designed for hackathon demo. Production requires: KYC compliance, audit, legal entity._
