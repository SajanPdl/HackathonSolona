...
export function AnimatedHero() {
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen overflow-hidden bg-[#F5F5F5]">
      <BackgroundAnimation />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20 w-full">
          <div className="grid lg:grid-cols-2 gap-12 xl:gap-16 items-center">
            <div className="space-y-8">
              ...
              >
                Fast, low-cost remittance powered by blockchain technology. 
                Your family in Nepal receives cash instantly from verified local agents.
              </p>
              ...
              <div ref={statsRef} className="flex items-center gap-8 pt-4 opacity-0">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-[#6B7280]">15k+ Users</span>
                </div>
                <div className="h-10 w-px bg-gray-200" />
                <div className="flex items-center gap-1.5">
                  <div className="flex">
                    {[1,2,3,4,5].map((i) => (
                      <svg key={i} className="w-4 h-4 text-[#FBBF24] -ml-0.5 first:ml-0" fill="currentColor" viewBox="0 0 20 20">
  ...
  const steps = [
    {
      icon: Wallet,
      title: 'Sender',
      desc: 'Initiates transfer with USDC',
      color: '#B91C1C',
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    boxShadow: isActive ? `0 20px 40px -12px ${step.glow}` : 'none',
                  }}
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-[#111827] text-lg">{step.title}</h4>
                    ...
                    <div className="w-8 h-8 rounded-full bg-white border-2 border-gray-200 flex items-center justify-center shadow-sm">
                      <div
                        className={`w-3 h-3 rounded-full transition-all duration-500 ${
                          isActive ? 'bg-[#B91C1C] scale-100' : 'bg-gray-300 scale-75'
                        }`}
                      />
                    </div>
                  </div>
