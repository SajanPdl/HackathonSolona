...
import { Wallet, ArrowRight, CheckCircle, Zap, Shield, Users, Globe, Sparkles } from 'lucide-react';
...
function Scene({ isActive, children }: SceneProps) {
  return (
    <div className={`absolute inset-0 transition-all duration-1000 ease-out ${isActive ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
      {children}
    </div>
  );
}
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      scenes?.forEach((scene, index) => {
        ...
        if (index === 0) {
          gsap.fromTo(scene.querySelector('.hero-title'),
          ...
          gsap.fromTo(scene.querySelector('.hero-badge'),
        ...
        if (index === 2) {
          gsap.fromTo(scene.querySelector('.flow-line'),
            { scaleX: 0 },
            {
              scaleX: 1,
              duration: 1.5,
        ...
        if (index === 4) {
          gsap.fromTo(scene.querySelector('.cash-card'),
        ...
        <div className="flex flex-col gap-3">
          {scenes.map((scene, index) => (
            <button
              key={scene.id}
              onClick={() => {
                containerRef.current?.querySelectorAll('.scene')[index]?.scrollIntoView({ behavior: 'smooth' });
              }}
              className={`relative w-3 h-3 rounded-full transition-all duration-300 ${
                activeScene === index ? 'bg-[#B91C1C] scale-125' : 'bg-gray-300 hover:bg-gray-400'
              }`}
            >
              {activeScene === index && (
            ...
            <div className="relative w-full h-full flex items-center justify-center">
              ...
              <div className="relative z-10 text-center max-w-5xl px-8">
                <div className="hero-badge inline-flex items-center gap-2 px-4 py-2 bg-white/90 backdrop-blur rounded-full border border-gray-200 shadow-lg mb-8">
                  ...
                  <span className="text-sm font-medium text-[#111827]">Live on Solana Devnet</span>
                </div>
                ...
                <h1 className="hero-title text-6xl md:text-8xl lg:text-9xl font-bold text-[#111827] leading-[0.95] tracking-tight mb-8">
                  ...
                  <span className="relative inline-block">
                    ...
                    <svg className="absolute -bottom-3 left-0 w-full" viewBox="0 0 300 12" fill="none">
                      <path d="M5 10C80 4 220 4 295 10" stroke="#B91C1C" strokeWidth="4" strokeLinecap="round" />
                    </svg>
                  </span>{' '}
                  Instantly
                </h1>
            ...
            <div className="grid lg:grid-cols-2 gap-16 max-w-7xl mx-auto px-8 items-center">
              <div className="visual-card order-2 lg:order-1">
                <div className="relative">
                  <div className="w-80 h-96 mx-auto bg-gradient-to-br from-[#111827] to-[#1F2937] rounded-[2rem] p-6 shadow-2xl">
                    ...
                    <div className="text-white text-sm mb-6">Sending to Nepal</div>
              ...
              <div className="scene-text order-1 lg:order-2">
                ...
                <p className="text-xl text-[#6B7280] max-w-lg leading-relaxed">
                  Connect your Phantom wallet and send USDC. No bank transfers, no waiting days. Just fast, direct transactions.
                </p>
          ...
          <Scene isActive={activeScene === 3}>
            <div className="grid lg:grid-cols-2 gap-16 max-w-7xl mx-auto px-8 items-center">
              <div>
                ...
                <p className="text-xl text-[#6B7280] max-w-lg leading-relaxed">
                  Share a secure claim code with your recipient. They can withdraw from any verified AamaPay agent nearby. No app download needed.
                </p>
              </div>
          ...
          <Scene isActive={activeScene === 4}>
            <div className="grid lg:grid-cols-2 gap-16 max-w-7xl mx-auto px-8 items-center">
                  ...
                  <div className="w-80 h-[450px] bg-gradient-to-br from-[#16A34A]/10 to-[#16A34A]/5 rounded-[2rem] p-6 border border-[#16A34A]/20">
                    <div className="w-full h-48 bg-white rounded-2xl shadow-lg flex items-center justify-center mb-6">
                      <div className="text-center">
                        ...
                        <p className="mt-2 text-sm text-[#6B7280]">Agent confirmed</p>
                      </div>
                    </div>
                    <div className="text-center">
                      <p className="font-bold text-[#111827] text-lg">Cash Ready!</p>
                      <p className="text-sm text-[#6B7280] mb-4">Kathmandu, Nepal</p>
              ...
              <div className="order-1 lg:order-1">
                ...
                <p className="text-xl text-[#6B7280] max-w-lg leading-relaxed">
                  Your family visits any verified AamaPay agent with the claim code. Cash in hand within minutes. Zero bank visits needed.
                </p>
                <div className="mt-8 flex items-center gap-4">
                  <div className="flex -space-x-3">
                    {['KTM', 'PKR', 'BIR'].map((c, i) => (
                      <div key={i} className="w-10 h-10 rounded-full bg-gradient-to-br from-[#16A34A] to-[#15803D] border-2 border-white flex items-center justify-center text-white text-xs font-bold">
                        {c}
                      </div>
                    ))}
                  </div>
                  <span className="text-sm text-[#6B7280]">500+ agents across Nepal</span>
                </div>
              </div>
            </div>
          </Scene>
          ...
          <Scene isActive={activeScene === 5}>
            <div className="text-center max-w-4xl px-8">
              ...
              <p className="text-xl md:text-2xl text-[#6B7280] max-w-2xl mx-auto mb-12">
                Send money to Nepal in seconds. Your family receives cash instantly. 
                No banks, no fees, no hassle.
              </p>
              ...
              <div className="mt-16 flex items-center justify-center gap-8">
                <div className="text-center">
                  <p className="text-3xl font-bold text-[#111827]">$2M+</p>
