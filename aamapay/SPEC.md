...
AamaPay is a decentralized remittance platform enabling diaspora workers to send SOLONA to Nepal, where recipients can withdraw cash through verified merchant agents or hold in their wallets. The platform bridges traditional cash-out networks with blockchain efficiency, creating a compliant, low-cost alternative to Western Union and MoneyGram.
...
Sender (overseas)
    │
    ▼
[Phantom Wallet] ──SOLONA──▶ [Solana Smart Contract (Escrow)]
    │                              │
